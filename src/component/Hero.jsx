  ...
  return (
    <div className="">
      <div className="w-full flex-col">
        <div className="relative md:h-full h-[50vh]">
          <div className="w-full h-full bg-linear-to-t from-black/90 to-black/30 absolute"></div>
          <img
            src={block1}
            className="md:w-full md:h-auto h-[50vh] w-full bg-cover"
            alt="Hero Data"
          />
          <p
          ...
          <div className="absolute bottom-4 z-[2000] left-4">
            <div className="flex flex-row justify-center">
              <div className="flex flex-row align-middle justify-center me-4">
                ...
                <p className="poppins-reguler ms-2 text-xs md:text-base text-white">
                  {HeroData[0].phone1}
                </p>
              </div>
